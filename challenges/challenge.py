...
class ChallengeBase(threading.Thread):
    ...
    def run(self):
      ...
      while self.running:
        ...
        #                                                  #
        ####################################################
        debug.print_to_all_devices("challenge base class !!")  # this line can be removed
    ...
    def button_cross_pressed(self):
        debug.print_to_all_devices("x_button_pressed() in challenges/ChallengeBase class")
    def button_cross_released(self):
        debug.print_to_all_devices("x_button_released() in challenges/ChallengeBase class")
    
    def button_circle_pressed(self):
        debug.print_to_all_devices("circle_button_pressed() in challenges/ChallengeBase class")
    def button_circle_released(self):
        debug.print_to_all_devices("circle_button_released() in challenges/ChallengeBase class")
    
    
    def button_triangle_pressed(self):
        debug.print_to_all_devices("triangle_button_pressed() in challenges/ChallengeBase class")
    def button_triangle_released(self):
        debug.print_to_all_devices("triangle_button_released() in challenges/ChallengeBase class")

    def button_square_pressed(self):
        debug.print_to_all_devices("square_button_pressed() in challenges/ChallengeBase class")
    def button_square_released(self):
        debug.print_to_all_devices("square_button_released() in challenges/ChallengeBase class")
    
    def button_L1_pressed(self):
        debug.print_to_all_devices("L1_pressed() in challenges/ChallengeBase class")
    def button_L1_released(self):
        debug.print_to_all_devices("L1_released() in challenges/ChallengeBase class")
    
    def button_L2_pressed(self):
        debug.print_to_all_devices("L2_pressed() in challenges/ChallengeBase class")
    def button_L2_released(self):
        debug.print_to_all_devices("L2_released() in challenges/ChallengeBase class")
    
    def button_R1_pressed(self):
        debug.print_to_all_devices("R1_pressed() in challenges/ChallengeBase class")
    def button_R1_released(self):
        debug.print_to_all_devices("R1_released() in challenges/ChallengeBase class")
    
    def button_R2_pressed(self):
        debug.print_to_all_devices("R2_pressed() in challenges/ChallengeBase class")
    def button_R2_released(self):
        debug.print_to_all_devices("R2_released() in challenges/ChallengeBase class")
