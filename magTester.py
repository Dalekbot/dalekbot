...
# also do some tests with the DalekV2Drive functions to see if they make any difference
...
def speedtest():
  ...
  DalekV2Drive.turnForwardRight(speed,speed)
  time.sleep(0.5)
  speed +=10
  mag = DalekSpi.getMag()
  if mag >greatestMag:
...
def speedtest2():
  global speed, greatestMag
  DalekV2Drive.turnForwardLeft(speed,speed)
  time.sleep(0.5)
  speed -=10
  mag = DalekSpi.getMag()
  if mag >greatestMag:
